  ...
  return (
    <div className="container max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="flex flex-col lg:flex-row gap-6 h-full items-stretch">
        <div className="p-6 min-h-[460px] h-fit justify-center border flex flex-col gap-6 border-gray-300 w-full rounded-xl lg:max-w-[330px]">
          <div>
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <div className="inline-flex items-center justify-center rounded-md text-black border px-2 py-0.5 text-xs font-medium w-fit bg-amber-400 whitespace-nowrap shrink-0 gap-1 transition-[color,box-shadow] overflow-hidden border-transparent ml-auto">
                {orders.length}
              </div>
            </button>
